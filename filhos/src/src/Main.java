...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        //creating a population of 10000 families, you can change the number in line 16/19 if you want.
        for (int i = 0; i<10000; i++) {
            populacao[i] = new Familia();
        }

        //counting the numbers of families that have a girl in it(pop_girls) and that have a 2 girls(count1).
        ...
        //counting the numbers of families that have a girl named "a"(pop_a) and the ones that have 2 girls, one of witch named "a".
        for (Familia familia:populacao) {
